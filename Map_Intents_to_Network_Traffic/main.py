...
def preliminary_labeling(category_tree: Category, segs: List[List[str]]):
    ...
    #    print("文档{}的向量表示: {}".format(i+1, document_vector.toarray()))
...
def main(word_file: str, cropus_file: str, result_file: str,p_file: str, model_save_path=None):
    """
    模型训练主函数
    ...
    #fw = open(p_file, "w", encoding="utf-8")
    #for i in range(len(datas)):
        #for j in range(3):
            #fw.write(str(p_c_d[i, j]))
        #fw.write("\n")
...
if __name__ == "__main__":
    ...
    main(word_file="resources/dict/words_snips.txt",
         cropus_file="resources/cropus/snips_data.txt",
         result_file="resources/cropus/snips_data_result.txt",
         p_file="resources/cropus/snips_p_result.txt",
